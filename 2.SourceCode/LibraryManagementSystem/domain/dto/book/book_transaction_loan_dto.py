...
class BookTransactionLoanDTO:
    def __init__(self, book_id=None, title=None, author=None, cover=None, landing_page=None, hashtag=None, genre_category=None, publisher=None, publish_year=None, location=None, is_display=0, qty_oh=0, qty_allocated=0, is_delete=0, created_dt=None, created_by=None, update_dt=None, update_by=None, is_out_of_stock=False):
    ...
    def set_is_out_of_stock(self, is_out_of_stock):
        self.is_out_of_stock = is_out_of_stock